...
<body>
    ...
    <c:if test="${not empty sessionScope.erroAtualizarProfissional}">
        <script>
            alert("${sessionScope.erroAtualizarProfissional}");
        </script>
    </c:if>
    ...
    <fmt:bundle basename="messages">
        ...
        <div class="formulario">
            <form id="forms" action="/AgendarConsultas/profissional" method="POST">
